    ...
    internal sealed class MotionVectorsPersistentData
    {
        ...
        public void SetGlobalMotionMatrices(RasterCommandBuffer cmd, XRPass xr)
        {
...
#endif
            {
                ...
                // META CHANGE START: Set unity_MatrixPrevVP for VR motion vectors compatibility
                cmd.SetGlobalMatrix("unity_MatrixPrevVP", previousViewProjectionStereo[passID]);
                // META CHANGE END
