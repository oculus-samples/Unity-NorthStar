    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (cameraData.renderType == CameraRenderType.Base)
            {
                ...
                if (cameraData.xr.enabled)
                {
                    // META CHANGE START: Update XR MSAA samples based on intermediate render texture usage for VR performance
                    Experimental.Rendering.XRSystem.SetDisplayMSAASamples(intermediateRenderTexture ? MSAASamples.None : (MSAASamples)cameraTargetDescriptor.msaaSamples);
                    // META CHANGE END
            ...
            ref CameraData cameraData)
        {
            ...
            if (renderingModeActual == RenderingMode.ForwardPlus && UniversalRenderPipeline.asset.ShouldUseReflectionProbeBlending())
            {
