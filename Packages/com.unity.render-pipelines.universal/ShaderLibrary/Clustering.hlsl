...
#endif
// META CHANGE START: Added _REFLECTION_PROBE_ATLAS check to reduce shader complexity when atlas is not used
#if MAX_LIGHTS_PER_TILE > 32 || (!defined(_ENVIRONMENTREFLECTIONS_OFF) && defined(_REFLECTION_PROBE_ATLAS))
// Original: #if MAX_LIGHTS_PER_TILE > 32 || !defined(_ENVIRONMENTREFLECTIONS_OFF)
